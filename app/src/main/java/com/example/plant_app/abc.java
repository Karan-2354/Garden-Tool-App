...
public class abc  extends RecyclerView.Adapter<abc.myviewholder>
{
    List<Product> products;
    TextView rateview;
    public abc(List<Product> products, TextView rateview) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull abc.myviewholder holder, int position) {
